...
This repository implements the pipeline described in `Data/problem_statement.md`:
...
- `Data/train/patient_XX/text_N.md`
- `Data/train/labels/patient_XX.json` (ground truth)
- `Data/dev/patient_XX/text_N.md` (unlabeled)
...
**Script:** `python -m Clinical_Nlp_Extraction.train --data-dir ./Data/train --taxonomy-path ./Data/taxonomy.json`
